...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    describe "#standard_revenue" do
      ...
      it "works when there are no discounts at all" do
        @merchant1 = Merchant.create!(name: 'Hair Care')
        @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1)
        @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
        @customer_1 = Customer.create!(first_name: 'Joey', last_name: 'Smith')
        ...
        expect(@invoice_1.standard_revenue).to eq(100.0)
      end
    end
    ...
    describe "#total_discounted_revenue" do
      ...
      it "handles 100% discounts" do
        ...
        @ii_1 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_1.id, quantity: 9, unit_price: 10, status: 2)
        @ii_11 = InvoiceItem.create!(invoice_id: @invoice_1.id, item_id: @item_8.id, quantity: 1, unit_price: 10, status: 1)
        BulkDiscount.create!(percent: 100, quantity: 1, merchant_id: @merchant1.id)

        expect(@invoice_1.total_discounted_revenue).to eq(0.0)
      end

      it "handles there being no discounts" do
        @merchant1 = Merchant.create!(name: 'Hair Care')
        @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1)
        @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
        @customer_1 = Customer.create!(first_name: 'Joey', last_name: 'Smith')
        ...
        expect(@invoice_1.total_discounted_revenue).to eq(100.0)
      end
    end
  end
end
